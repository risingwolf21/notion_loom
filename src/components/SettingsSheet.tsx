  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent title="Settings">
        ...
        <div className="px-4 py-4 space-y-3 bg-[var(--bg)]">
          {/* Connection card */}
          <Card>
              ...
              {!FIXED_WORKER_URL && (
                <div className="space-y-1.5">
                  <div className="flex items-center gap-1.5">
                    <Link2 size={13} className="text-[var(--fg3)]" />
                    <label className="text-sm font-medium text-[var(--fg)]">Worker URL</label>
                  </div>
                  <Input
                    value={workerUrl}
                    ...
                    autoCapitalize="none"
                  />
                  <p className="text-xs text-[var(--fg3)]">URL of your Notion CORS proxy.</p>
                </div>
              )}

              <div className="space-y-1.5">
                <div className="flex items-center gap-1.5">
                  <Shield size={13} className="text-[var(--fg3)]" />
                  <label className="text-sm font-medium text-[var(--fg)]">Integration Token</label>
                </div>
          ...
          <Card>
            <CardContent className="pt-5 pb-4">
              ...
              <p className="text-xs text-[var(--fg3)] text-center mt-2 leading-relaxed">
